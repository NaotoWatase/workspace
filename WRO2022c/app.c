...
void main_task(intptr_t unused) {
   ...
   (void)sta_cyc(MUSIC_CYC);
    ...
    walltrace_length(150, 60, 8);
    steering_time(1100, 30, 0);
    steering(11.5, -25, 0);
    tank_turn(90, -30, 30);
    steering_time(1500, -30, 0);
    walltrace_length(55, 30, 13.5);
    steering(10, 30, 0);
    arm(down);
    tank_turn(120, 0, -30);
    tank_turn(240, 30, 0);
