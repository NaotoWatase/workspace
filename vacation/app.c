...
void brown_nkc(){
    ...
    case CHEMICAL:
        ...
        if (location[8] == chemical) {
            straight(5.5, 50, false);
            chemical_taker(8, LEFT);
            straight(65.5, 80, true);
        }
        else {
            straight(31.5, -80, false);
            obj_check(8, LEFT);
            chemical_taker(8, LEFT);
            straight(97, 80, false);
        }
        break;
    default:
        turn(180, -30, 0);
