...
void main_task(intptr_t unused) {
    ...
    walltrace_length_p(1000, 25, 11, 20);
    ...
    tank_turn(25, 25, 0);
    steering(4.5, 30, 0);
    walltrace_length_p(18.5, 32, 9.5, 20);
    steering(10, 35, 0);
    tslp_tsk(200 * MSEC);
    ...
    chemical_taker(2);
    steering(6.5, 30, 0);
    walltrace_length_p(20, 25, 9.5, 20);
    /*steering(35, 25, 0);*/
    ...
    water(2);
    water(3);
    walltrace_length_p(13, 35, 9.5, 20);
    ...
    /*red*/
    steering(6.5, 30, 0);
    walltrace_length_p(16.5, 35, 9.5, 20);
